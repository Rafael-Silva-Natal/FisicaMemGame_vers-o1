const images = [
    { id: 1, type: "pergunta", src: "./images2/pergunta1.png", matched: false },
    { id: 2, type: "pergunta", src: "./images2/pergunta2.png", matched: false },
    { id: 3, type: "pergunta", src: "./images2/pergunta3.png", matched: false },
    { id: 4, type: "pergunta", src: "./images2/pergunta4.png", matched: false },

    { id: 5, type: "resposta", src: "./images2/resposta1.png", questionId: 1, matched: false },
    { id: 6, type: "resposta", src: "./images2/resposta2.png", questionId: 2, matched: false },
    { id: 7, type: "resposta", src: "./images2/resposta3.png", questionId: 3, matched: false },
    { id: 8, type: "resposta", src: "./images2/resposta4.png", questionId: 4, matched: false },

    { id: 9, type: "pergunta", src: "./images2/pergunta5.png", matched: false },
    { id: 10, type: "pergunta", src: "./images2/pergunta6.png", matched: false },
    { id: 11, type: "pergunta", src: "./images2/pergunta7.png", matched: false },
    { id: 12, type: "pergunta", src: "./images2/pergunta8.png", matched: false },
    
    { id: 13, type: "resposta", src: "./images2/resposta5.png", questionId: 9, matched: false },
    { id: 14, type: "resposta", src: "./images2/resposta6.png", questionId: 10, matched: false },
    { id: 15, type: "resposta", src: "./images2/resposta7.png", questionId: 11, matched: false },
    { id: 16, type: "resposta", src: "./images2/resposta8.png", questionId: 12, matched: false }
  ];
...
function checkCards() {
  ...
  if (image1.type === "pergunta" && image2.type === "resposta" && image1.id === image2.questionId) {
    ...
    setTimeout(() => {
      card1.style.backgroundImage = `url(./images2/verso.png)`;
      card2.style.backgroundImage = `url(./images2/verso.png)`;
      flippedCards = [];
      document.getElementById("checkButton").setAttribute("disabled", "true");
    }, 1000);
  }
...
// colagem da sugestão...
  ...
  checkButton.addEventListener("click", checkCards);
      ...
      var botao = document.getElementById("meuBotao2");

      // Adiciona um ouvinte de evento ao botão
      botao.addEventListener("click", redirecionar2);
